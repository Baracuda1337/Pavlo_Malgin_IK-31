...
```text
malhin@malhin-VirtualBox:~/tpis/Pavlo_Malgin_IK-31/lab2$ pipenv -h
...
malhin@malhin-VirtualBox:~/tpis/Pavlo_Malgin_IK-31/lab2$ 
```
...
Результат виконання:
```text
(lab2-KAIxQWkc) malhin@malhin-VirtualBox:~/tpis/Pavlo_Malgin_IK-31/lab2$ python app.py
========================================
...
Date is:  10-28-2021
success
(lab2-KAIxQWkc) malhin@malhin-VirtualBox:~/tpis/Pavlo_Malgin_IK-31/lab2$ 
```
...
Виконанння програми:
```text
(lab2-KAIxQWkc) malhin@malhin-VirtualBox:~/tpis/Pavlo_Malgin_IK-31/lab2$ pytest tests/tests.py
============================= test session starts ==============================
...
Виконання тесту:
```text
(Lab_2) rootdir: /home/malhin/tpis/Pavlo_Malgin_IK-31/lab2
